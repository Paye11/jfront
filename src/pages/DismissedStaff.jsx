...
const DismissedStaff = () => {
  ...
  // Fetch all courts & dismissed staff
  useEffect(() => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold">Dismissed Staff</h2>
      </div>
              ...
              {loading ? (
                ...
                staffList.map((s) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{formatDate(s.dismissalDate)}</td>
                ...
                <tr>
                  <td colSpan="10" className="px-6 py-8 text-center text-gray-500">
                    <p className="text-lg font-medium">No dismissed staff members found</p>
                  </td>
                </tr>
              )}
            </tbody>
